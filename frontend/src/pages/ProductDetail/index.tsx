...
import { Star, Heart, Plus, Minus, ShoppingCart, Sparkles, Shield, RefreshCw } from 'lucide-react';
...
const ProductDetail = () => {
  ...
  const product = {
    ...
    highlight: 'Chiếc điện thoại thời thượng dành cho người trẻ năng động, tối ưu mọi trải nghiệm chụp hình, giải trí và công việc.'
  };
  ...
  const bundleProducts = [
    { id: 201, name: 'Ốp lưng Silicon Pink', price: '290.000đ', oldPrice: '450.000đ', image: '/images/brand_apple.png', badge: 'SALE' },
    { id: 202, name: 'Sạc nhanh 65W GaN', price: '650.000đ', oldPrice: '890.000đ', image: '/images/brand_samsung.png', badge: 'HOT' },
    { id: 203, name: 'PinkBuds Pro 2', price: '1.890.000đ', oldPrice: '2.490.000đ', image: '/images/brand_xiaomi.png' }
  ];
      ...
      <div className="mx-auto w-full max-w-[1440px] px-4 sm:px-6 lg:px-8 xl:px-10">
        ...
        <div className="bg-white rounded-[32px] p-6 xl:p-8 shadow-sm grid gap-10 lg:grid-cols-[1.25fr_0.95fr] mb-10">
          <div className="flex flex-col gap-6">
            <div className="relative overflow-hidden rounded-[32px] border border-gray-100 bg-gray-50 p-6 flex flex-col items-center justify-center min-h-[520px]">
              <img src={mainImage} alt={product.name} className="max-h-full w-full object-contain" />
            ...
            <div className="flex items-center justify-center gap-4 overflow-x-auto py-3">
              {images.map((img, index) => (
                ...
                >
                  <img src={img} alt={`Thumbnail ${index + 1}`} className="h-20 w-20 object-contain" />
                </button>
              ))}
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm text-gray-600">
              ...
              <div className="rounded-3xl border border-gray-100 bg-[#FBFBFB] p-4 flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-gray-800">1 đổi 1 trong 30 ngày</p>
          ...
          <div className="flex flex-col gap-8">
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-600 max-w-2xl">{product.highlight}</p>
            ...
            <div className="rounded-3xl border border-[#F5D3DF] bg-[#FFF0F4] p-6 grid gap-5">
              <div>
                <p className="text-sm text-gray-500 uppercase tracking-[0.2em] mb-2">Giá bán</p>
                <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                  <p className="text-4xl font-bold text-[#E91E63]">{product.price}</p>
                  <div className="text-right">
                    <p className="text-sm text-gray-400 line-through">{product.oldPrice}</p>
                    <span className="inline-flex rounded-full bg-[#E91E63] px-3 py-1 text-[10px] font-bold uppercase tracking-[0.2em] text-white">TIẾT KIỆM 15%</span>
                  </div>
                </div>
              </div>
              ...
              <div className="grid gap-4">
                <div>
                  <p className="text-xs font-bold uppercase tracking-[0.24em] text-gray-600 mb-2">Chọn bộ nhớ</p>
                ...
                <div>
                  <p className="text-xs font-bold uppercase tracking-[0.24em] text-gray-600 mb-2">Chọn màu sắc</p>
                  <div className="flex flex-wrap gap-3">
                    {colors.map((color) => (
                      <button
                        key={color.name}
                ...
                <div>
                  <p className="text-xs font-bold uppercase tracking-[0.24em] text-gray-600 mb-2">Số lượng</p>
                  <div className="inline-flex overflow-hidden rounded-full border border-gray-200 bg-white">
                    ...
                    <span className="w-14 text-center text-sm font-semibold text-gray-800">{quantity}</span>
                    <button
                      type="button"
                      className="px-4 py-3 text-gray-600 hover:bg-gray-50"
            ...
            <div className="grid gap-3">
              <Button
                ...
                onClick={() => addToCart({ ...product, selectedStorage, selectedColor, quantity })}
              >
                MUA NGAY
              </Button>
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                <Button variant="outline" size="md" className="py-3 text-xs text-[#E91E63] border-[#E91E63] hover:bg-[#FFF0F4]">
                  TRẢ GÓP 0%
                </Button>
                <Button
                  variant="outline"
        ...
        <div className="grid gap-4 md:grid-cols-3 mb-10">
          ...
          <div className="rounded-3xl border border-gray-100 bg-white p-5 shadow-sm">
            <p className="text-sm font-semibold text-gray-800">Ưu đãi PinkPay</p>
            <p className="text-sm text-gray-500 mt-2">Giảm ngay 500.000đ</p>
          </div>
        </div>

        <div className="bg-white rounded-3xl p-8 shadow-sm mb-10">
          <h3 className="text-lg font-bold text-gray-800 mb-5">Mua kèm tiết kiệm hơn</h3>
        ...
        <div className="grid gap-8 lg:grid-cols-[1.4fr_0.95fr]">
          <div className="rounded-3xl bg-white p-8 shadow-sm space-y-6">
            <h3 className="text-lg font-bold text-gray-800 border-b border-gray-100 pb-3">Đặc điểm nổi bật</h3>
            <div className="space-y-6 text-sm text-gray-600 leading-relaxed">
              <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr] items-center">
                <div>
                  <h4 className="font-bold text-gray-800 mb-2">Thiết kế thanh lịch, màu hồng thời thượng</h4>
                  <p>PinkPhone Ultra X 2024 nổi bật với thiết kế nguyên khối, mặt lưng kính mờ và đường viền bo cong mềm mại, phù hợp với phong cách trẻ trung.</p>
                </div>
                <img src="/images/login_bg.png" alt="Thiết kế" className="h-64 w-full rounded-3xl object-cover border border-gray-100" />
              </div>
              <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr] items-center">
                <img src="/images/prod_s24.png" alt="Màn hình" className="h-64 w-full rounded-3xl object-cover border border-gray-100" />
                <div>
                  <h4 className="font-bold text-gray-800 mb-2">Màn hình rực rỡ, chuyển động mượt mà</h4>
                  <p>Màn hình Super Retina XDR OLED 120Hz đem lại độ sáng cao, màu sắc chân thực và trải nghiệm giải trí tuyệt vời.</p>
                </div>
              </div>
              <div>
                <h4 className="font-bold text-gray-800 mb-2">Hiệu năng mạnh mẽ cho mọi nhu cầu</h4>
                <p>Chip Pink Processor A18 Pro cùng 8GB RAM giúp máy chạy đa nhiệm ổn định, chơi game và xử lý đa ứng dụng không giật lag.</p>
              </div>
            </div>
          </div>

          <div className="rounded-3xl bg-white p-6 shadow-sm">
            <h3 className="text-lg font-bold text-gray-800 border-b border-gray-100 pb-3 mb-4">Thông số kỹ thuật</h3>
            <div className="space-y-3">
              {specs.map((spec, idx) => (
                <div key={idx} className="flex justify-between gap-4 border-b border-gray-100 py-2 text-sm">
