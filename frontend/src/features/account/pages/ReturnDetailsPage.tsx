...
export function ReturnDetailsPage() {
  ...
  return (
    <AccountShell
      ...
      description="Vui lòng cung cấp thông tin chi tiết về sản phẩm bạn muốn đổi trả để chúng tôi có thể hỗ trợ tốt nhất."
    >
      <div className="-mt-2 w-full max-w-3xl mx-auto flex flex-col gap-8">
        ...
        <form className="space-y-8">
          ...
          <section className="bg-surface-container-lowest p-6 md:p-8 rounded-3xl shadow-sm border border-outline-variant/30">
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="ORD-2024-001" selected>
            ...
            <div className="space-y-4">
              <div className="p-4 border border-outline-variant/30 rounded-2xl bg-surface-container-lowest shadow-sm flex flex-col md:flex-row gap-5 items-start md:items-center">
                ...
                <div className="w-full md:w-auto flex items-center justify-center gap-3 bg-surface-container-low p-2 rounded-xl border border-outline-variant/30">
                  <label className="text-[13px] font-bold text-on-surface-variant px-2">
                    Số lượng trả:
                  </label>
                  <input
                    className="w-14 p-2 text-center rounded-lg border border-outline-variant/50 outline-none text-[15px] font-bold cursor-not-allowed bg-surface"
                    type="number"
                    value="1"
                    readOnly
                  />
          ...
          <section className="bg-surface-container-lowest p-6 md:p-8 rounded-3xl shadow-sm border border-outline-variant/30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="relative">
                  <select
                    className="w-full appearance-none bg-surface-container-low p-4 rounded-xl border border-outline-variant/50 outline-none transition-all text-[15px] font-medium text-on-surface cursor-not-allowed"
                    id="return-reason"
                    disabled
                  >
                    <option value="DEFECTIVE" selected>
            ...
            <div className="mt-6">
              ...
              <textarea
                className="w-full bg-surface-container-low p-4 rounded-xl border border-outline-variant/50 outline-none transition-all text-[15px] font-medium text-on-surface resize-none cursor-not-allowed"
                id="return-notes"
                rows={3}
                readOnly
                value="Sản phẩm bị lỗi chức năng màn hình khi tôi mở lên sử dụng."
              ></textarea>
            </div>
          </section>
          ...
          <section className="bg-surface-container-lowest p-6 md:p-8 rounded-3xl shadow-sm border border-outline-variant/30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="relative group">
                ...
                />
                <label
                  className="flex flex-col p-6 border-2 border-outline-variant/30 rounded-2xl transition-all peer-checked:border-primary peer-checked:bg-[#fff0f1]/50 cursor-not-allowed"
                  htmlFor="type-refund"
                >
          ...
          <section className="bg-surface-container-lowest p-6 md:p-8 rounded-3xl shadow-sm border border-outline-variant/30">
            ...
            <div className="p-5 bg-tertiary-fixed/20 rounded-2xl border-l-[6px] border-tertiary-fixed-dim flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div>
