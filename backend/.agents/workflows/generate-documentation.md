...
Rules 00/40/60, `phone-store-project-context` và skill chuyên môn tương ứng.
...
5. Với API, mô tả auth, request, response, error, idempotency và example đã redaction.
...
10. So sánh lại tài liệu với code/test.
