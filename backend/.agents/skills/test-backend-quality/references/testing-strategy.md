...
| Contract       | REST/OpenAPI/provider adapter                           | OpenAPI linter/diff + conformance test phù hợp |
...
Với Swagger, tách ba bằng chứng: spec hợp lệ, implementation khớp spec và UI/profile exposure đúng. Chỉ mở được Swagger UI chưa đủ để kết luận API contract pass.
