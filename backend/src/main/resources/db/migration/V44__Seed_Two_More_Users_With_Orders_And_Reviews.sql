...
SET @prod_ip16_id = (SELECT id FROM products WHERE slug = 'iphone-16' LIMIT 1);
SET @var_ip16_34_id = (SELECT id FROM product_variants WHERE sku = 'PHONE-034-128GB' LIMIT 1);

SET @prod_ip15p_id = (SELECT id FROM products WHERE slug = 'iphone-15-plus' LIMIT 1);
SET @var_ip15p_25_id = (SELECT id FROM product_variants WHERE sku = 'PHONE-025-128GB' LIMIT 1);

SET @prod_ip16pm_id = (SELECT id FROM products WHERE slug = 'iphone-16-pro-max' LIMIT 1);
SET @var_ip16pm_43_id = (SELECT id FROM product_variants WHERE sku = 'PHONE-043-256GB' LIMIT 1);

SET @prod_ip16pro_id = (SELECT id FROM products WHERE slug = 'iphone-16-pro' LIMIT 1);
SET @var_ip16pro_40_id = (SELECT id FROM product_variants WHERE sku = 'PHONE-040-128GB' LIMIT 1);

SET @prod_ip16plus_id = (SELECT id FROM products WHERE slug = 'iphone-16-plus' LIMIT 1);
SET @var_ip16plus_38_id = (SELECT id FROM product_variants WHERE sku = 'PHONE-038-256GB' LIMIT 1);
